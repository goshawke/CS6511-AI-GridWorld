...
class API:
    ...
    def locate_me(self):
        ...
        conn.request("GET", "/aip2pgaming/api/rl/gw.php?type=location&teamId=1387", payload, headers)
    ...
    def get_runs(self):
        ...
        conn.request("GET", "/aip2pgaming/api/rl/score.php?type=runs&teamId=1387&count=10", payload, headers)
        res = conn.getresponse()
        data = res.read()
        print(data.decode("utf-8"))
    ...
    def get_score(self):
        ...
        conn.request("GET", "/aip2pgaming/api/rl/score.php?type=score&teamId=1387", payload, headers)
        res = conn.getresponse()
        data = res.read()
        print(data.decode("utf-8"))
